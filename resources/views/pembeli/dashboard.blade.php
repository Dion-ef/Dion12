...
<body class="">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
    <div class="container">
      <a class="navbar-brand">Delta Comp</a>
      ...
      <div class="collapse navbar-collapse">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <a class="nav-link" href="/dashboard/pembeli"><i class="fa fa-dashboard"></i> Beranda </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/profil/pembeli"><i class="fa fa-user" aria-hidden="true"></i> Profil</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/riwayat"><i class="fa fa-random" aria-hidden="true"></i> Riwayat Pembelian</a>
          </li>
          <li class="nav-item">
